...
export function Navbar({
  ...
  return <AppShell header={<Header height={60} fixed={true}>
            <Group spacing="xl" position="center" sx={{
      paddingTop: 10,
      paddingBottom: 10
    }}>
        ...
        width: 150,
        color: "#FFFFFF"
      }} leftIcon={<BsInfoCircle />} component="a" href="/about">
                About
              </Button>
              <Button variant="outline" style={{
        width: 150,
        color: "#FFFFFF"
      }} leftIcon={<SiGithub />} component="a" href="https://github.com/No767/Deltaline">
                GitHub
              </Button>
        ...
        color: "#FFFFFF"
                ...
                </Button>} placement="center" size="md">
          ...
          </Header>} children={undefined}></AppShell>;
}
